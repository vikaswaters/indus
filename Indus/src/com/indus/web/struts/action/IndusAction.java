...
public abstract class IndusAction extends Action {
	private static final Logger logger = Logger.getLogger(IndusAction.class);
	...
	private static ThreadLocal<Customer> threadLocalUserDetails = new ThreadLocal<Customer>();
	  ...
	  public static void setThreadLocalUserValue(Customer user) {
		  threadLocalUserDetails.set(user);
	  }

	  public static Customer getThreadLocalUserValue() {
	    return (Customer) threadLocalUserDetails.get();
	  }
